...
function sellerProfile() {
  ...
  useEffect(() => {
    axios.get(`https://backend-9yno.onrender.com/api/food-partner/${id}`,{withCredentials:true})
    .then((response)=>{
      setSeller(response.data.seller)
    })
    axios.get("https://backend-9yno.onrender.com/api/food", { withCredentials: true })
    .then((response)=>{
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white text-white font-sans relative overflow-hidden">
